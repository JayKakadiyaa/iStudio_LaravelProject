...
<head>
    ...
    <style>
        ...
        /* Navbar matching the design in your image */
        nav { 
            background: #0f766e; 
            padding: 15px 50px; 
            display: flex; 
        ...
        /* Welcome Card with the green accent border */
        .welcome-card { 
            background: white; 
            padding: 40px; 
            border-radius: 15px; 
        ...
        /* Action Section for redirecting to index */
        .action-box { 
            display: flex; 
            justify-content: space-between; 
            align-items: center; 
        ...
        .go-btn:hover { background: #115e59; }
    </style>
</head>
<body>
...
<div class="main-container">
    <div class="welcome-card">
        ...
        <p>You have successfully logged in to iSTUDIO. Your session is now active.</p>
    </div>
    ...
    <div class="action-box">
        ...
        <a href="{{ url('/') }}" class="go-btn">Go to Main Website</a>
    </div>
</div>
