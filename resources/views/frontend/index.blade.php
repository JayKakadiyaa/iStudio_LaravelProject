            ...
            <div class="row g-5 align-items-center mb-5">
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel header-carousel animated fadeIn">
                        <img class="img-fluid" src="{{asset('frontend/img/hero-slider-1.jpg')}}" alt="">
                        <img class="img-fluid" src="{{asset('frontend/img/hero-slider-2.jpg')}}" alt="">
                        <img class="img-fluid" src="{{asset('frontend/img/hero-slider-3.jpg')}}" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-7">
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.4s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{asset('frontend/img/project-3.jpg')}}" alt="">
                                <a class="project-overlay text-decoration-none" href="">
