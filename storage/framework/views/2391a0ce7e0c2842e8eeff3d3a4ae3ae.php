                ...
                <div class="col-lg-6 animated slideInRight">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-end mb-0">
                            <li class="breadcrumb-item"><a class="text-primary" href="<?php echo e(url('/')); ?>">Home</a></li>
...
unset($__errorArgs, $__bag); ?>" id="name" placeholder="Your Name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="email" placeholder="Your Email" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="Leave a message here" id="message" style="height: 150px"><?php echo e(old('message')); ?></textarea>
...
</html><?php /**PATH C:\xampp\htdocs\iStudio\resources\views/frontend/contact.blade.php ENDPATH**/ ?>