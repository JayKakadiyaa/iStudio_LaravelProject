    ...
    <div class="container py-5">
        ...
        <div class="row g-4">
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                <div class="pricing-card h-100 p-5 shadow-sm text-center">
                    ...
                    <a href="<?php echo e(url('/contact')); ?>" class="btn btn-istudio-outline w-100 py-3 mt-auto">Book Now</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                <div class="pricing-card featured h-100 shadow text-center position-relative">
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <a href="<?php echo e(url('/contact')); ?>" class="btn btn-istudio-fill btn-primary w-100 py-3 mt-auto">Get Started</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.7s">
                <div class="pricing-card h-100 p-5 shadow-sm text-center">
                    ...
                    <a href="<?php echo e(url('/contact')); ?>" class="btn btn-istudio-outline w-100 py-3 mt-auto">Enquire Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="text-center mt-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="p-4 bg-white rounded-3 shadow-sm d-inline-block">
                <p class="mb-0 text-muted"><i class="fa fa-info-circle text-primary me-2"></i> Custom commercial project? <a href="<?php echo e(url('/contact')); ?>" class="text-primary fw-bold">Request a custom quote</a></p>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\iStudio\resources\views/frontend/pricing.blade.php ENDPATH**/ ?>