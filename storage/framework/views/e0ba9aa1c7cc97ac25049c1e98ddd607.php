                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light mt-2">
                                <a href="<?php echo e(url('/feature')); ?>" class="dropdown-item">Features</a>
                        ...
                        <a href="<?php echo e(url('/dashboard')); ?>" class="nav-item nav-link">My Dashboard</a>
                    </div>
                </div>
            </nav>
        </div>
            ...
            <div class="row g-5 align-items-center mb-5">
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel header-carousel animated fadeIn">
                        <img class="img-fluid" src="<?php echo e(asset('frontend/img/hero-slider-1.jpg')); ?>" alt="">
                        <img class="img-fluid" src="<?php echo e(asset('frontend/img/hero-slider-2.jpg')); ?>" alt="">
                        <img class="img-fluid" src="<?php echo e(asset('frontend/img/hero-slider-3.jpg')); ?>" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-6 wow fadeIn" data-wow-delay="0.3s">
                            <img class="img-fluid h-75" src="<?php echo e(asset('frontend/img/about-2.jpg')); ?>" alt="">
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/project-1.jpg')); ?>" alt="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/project-2.jpg')); ?>" alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.4s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/project-3.jpg')); ?>" alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/project-4.jpg')); ?>" alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.6s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/project-5.jpg')); ?>" alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.7s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/project-6.jpg')); ?>" alt="">
                                <a class="project-overlay text-decoration-none" href="">
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p>“We create beautiful interior spaces with care and dedication. Our team works hard to design comfortable and stylish environments. We focus on quality, balance, and timeless design to give you the best results.”</p>
                    <p class="mb-5">“We design beautiful interiors with care and creativity. Our team focuses on quality, comfort, and style to create spaces that feel perfect over time. Every detail is handled with dedication to give you lasting and elegant results.”</p>
                ...
                <div class="col-lg-7">
                    <div class="row g-0">
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.2s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/service-1.jpg')); ?>" alt="">
                                    <h3>Interior Design</h3>
                                </a>
                                <p class="mb-0">We combine creativity and quality to design elegant interiors</p>
                            </div>
                        </div>
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.4s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/service-2.jpg')); ?>" alt="">
                                    <h3>Implement</h3>
                                </a>
                                <p class="mb-0">We combine creativity and quality to design elegant interiors</p>
                            </div>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.6s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/service-3.jpg')); ?>" alt="">
                                    <h3>Renovation</h3>
                                </a>
                                <p class="mb-0">We combine creativity and quality to design elegant interiors</p>
                            </div>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.8s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/service-4.jpg')); ?>" alt="">
                                    <h3>Commercial</h3>
                                </a>
                                <p class="mb-0">We combine creativity and quality to design elegant interiors</p>
                            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/team-1.jpg')); ?>" alt="">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/team-2.jpg')); ?>" alt="">
                        <div class="team-overlay">
                            <small class="mb-2">Architect</small>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/team-3.jpg')); ?>" alt="">
                        <div class="team-overlay">
                            <small class="mb-2">Architect</small>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/team-4.jpg')); ?>" alt="">
                        <div class="team-overlay">
                            <small class="mb-2">Architect</small>
                    ...
                    <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.2s">
                            ...
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="<?php echo e(asset('frontend/img/testimonial-1.jpg')); ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
                                        <h3>Sustainable Material</h3>
                                        <p>We create beautiful interiors with care and hard work. Our designs focus on balance, comfort, and long-lasting quality, even when the work is challenging.”</p>
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="<?php echo e(asset('frontend/img/testimonial-2.jpg')); ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
                                        <h3>Customer Satisfaction</h3>
                                        <p>Customer satisfaction is our top priority. We focus on quality work, timely delivery, and balanced designs to ensure every client is happy with the final result.</p>
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="<?php echo e(asset('frontend/img/testimonial-3.jpg')); ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
                                        <h3>Budget Friendly</h3>
                                        <p>“We offer stylish interior designs at affordable prices. Our team works efficiently to deliver quality results that fit your budget without compromising on comfort or style.”</p>
        ...
        <div class="container p-0">
            <div class="row g-0 align-items-center">
                <div class="col-md-5 ps-lg-0 text-start wow fadeIn" data-wow-delay="0.2s">
                    <img class="img-fluid w-100" src="<?php echo e(asset('frontend/img/newsletter.jpg')); ?>" alt="">
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <a class="btn btn-primary border-2 px-4" href="<?php echo e(url('pricing')); ?>">Upgrade Your Space</a>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
...
</html><?php /**PATH C:\xampp\htdocs\iStudio\resources\views/frontend/index.blade.php ENDPATH**/ ?>